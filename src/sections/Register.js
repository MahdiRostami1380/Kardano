    ...
    <section className="relative h-[613px] md:h-[430px] lg:h-[400px] xl:h-[480px] 2xl:h-[500px] isolate overflow-x-hidden">
      <div className="section-container flex flex-col lg:flex-row justify-start gap-4 xl:gap-6 h-full items-center lg:pt-48 xl:pt-60">
        <div className="w-full lg:w-[380px] xl:w-[460px] 2xl:w-[550px] mt-40 md:mt-14 lg:mt-0">
          <h2 className="font-KamandBlack font-[800] text-xl lg:text-[22px] xl:text-[28px] 2xl:text-[32px] mb-2 lg:mb-5">
            به خانواده بزرگ کادرانو بپیوندید
          </h2>
          <p className="font-Kamand font-normal text-[14px] lg:text-lg xl:text-xl 2xl:text-2xl">
            تخصص خود را با دیگران به اشتراک بگذارید و کسب درآمد کنید
          </p>
        </div>
        <Link
          href={"/"}
          className="w-full lg:w-fit bg-gradient-to-l from-[#FF9D29] to-[#F37915] rounded-xl xl:rounded-2xl 2xl:rounded-3xl py-3 xl:py-4 px-4 xl:px-6 2xl:py-6 2xl:px-8 mt-3 lg:mt-6 text-white flex gap-4 items-center xl:gap-6 2xl:gap-8 justify-center"
        >
